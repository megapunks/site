...
export default function GuidePage() {
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 mt-6">
              {[
                ...
                <div key={i} className="flex items-center space-x-4 p-3 bg-[#312e81] border border-yellow-300 rounded-xl">
  ...
  {[
    ...
    <div key={lvl.level} className="flex items-center space-x-4 p-3 bg-[#312e81] border border-yellow-300 rounded-xl">
