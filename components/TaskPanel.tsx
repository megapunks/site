...
type TaskType = "profile_share" | "discord" | "follow1" | "follow2" | "like_rt2" | "like_rt3" |
 "like_rt4" | "like_rt5" | "like_rt6" | "like_rt7" | "like_rt8" | "like_rt9" | "like_rt10" | "like_rt11" | "like_rt12" ;
...
const TASKS: Record<TaskType, {
  ...
  like_rt2: {
    ...
    taskId: "rt-task-2",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1940420492839555342",
    icon: "🔁",
    xp: 20,
  },
  like_rt3: {
  ...
  like_rt4: {
    ...
    taskId: "rt-task-4",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1932832490026086727",
    icon: "🔁",
    xp: 20,
  },
  like_rt5: {
    ...
    taskId: "rt-task-5",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1941178296462688504",
    icon: "🔁",
    xp: 20,
  },
  like_rt6: {
    ...
    taskId: "rt-task-6",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1943342227968692506",
    icon: "🔁",
    xp: 20,
  },
  like_rt7: {
    ...
    taskId: "rt-task-6",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1944061279842291921",
    icon: "🔁",
    xp: 20,
  },
  like_rt8: {
    ...
    taskId: "rt-task-8",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1944770137954844913",
    icon: "🔁",
    xp: 20,
  },
  like_rt9: {
    ...
    taskId: "rt-task-9",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1945878457360990682",
    icon: "🔁",
    xp: 20,
  },
  like_rt10: {
    ...
    taskId: "rt-task-10",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1948081308434870543",
    icon: "🔁",
    xp: 20,
  },
  like_rt11: {
    ...
    taskId: "rt-task-11",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1953138650943828374",
    icon: "🔁",
    xp: 20,
  },
  like_rt12: {
    ...
    taskId: "rt-task-12",
    taskType: "likeRT",
    url: "https://x.com/Megaeth_Punks/status/1953832332692984269",
    icon: "🔁",
    xp: 20,
  },
};
